...
export const BATCH_RATE_SYSTEM = `You are a senior talent advisor helping a job seeker find roles they can realistically get. Your job is to be their advocate, not a gatekeeper. Return ONLY a valid JSON object, no markdown, no explanation.`
...
Return ONLY a JSON object keyed by jobId, no markdown:
{
  "<jobId>": {
